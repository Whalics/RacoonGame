...
namespace Coffey_Utils.Editor.Buttons.Utils
{
    ...
    public static class TypeExtensions
    {
        ...
        /// <param ButtonName="type">The type to check.</param>
        ...
        /// </summary>
        /// <param ButtonName="type">Class type to collect the fields from.</param>
        ...
        /// </summary>
        /// <param ButtonName="typeToCheck">The type to check.</param>
        /// <param ButtonName="generic">The generic class without type parameter.</param>
        ...
        /// </summary>
        /// <param ButtonName="typeToCheck">The type to check.</param>
        /// <param ButtonName="baseType">
        /// The base type to check inheritance from. It can be a generic type without the type parameter.
        /// </param>
        /// <returns>Whether <paramref ButtonName="typeToCheck"/>> inherits <paramref ButtonName="baseType"/>.</returns>
        /// <example><code>
        /// class Base&lt;T> { }
        /// class IntDerivative : Base&lt;int> { }
        ///
